...
test("b16 : rfc4648 vectors", vectors.b16, ($) => {
...
test("b32 : rfc4648 vectors", vectors.b32, ($) => {
...
test("h32 : rfc4648 vectors", vectors.h32, ($) => {
...
test("c32 : crockford table", vectors.c32, ($) => {
...
test("b58 : reference vectors", vectors.b58, ($) => {
...
test("b64 : rfc4648 vectors", vectors.b64, ($) => {
...
test("u64 : rfc4648 vectors", vectors.u64, ($) => {
...
test("z85 : spec vectors", vectors.z85, ($) => {
...
test("a85 : wikipedia examples", vectors.a85, ($) => {
