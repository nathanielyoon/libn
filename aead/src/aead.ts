...
const construct = (ciphertext: Uint8Array, additional: Uint8Array) => {
...
export const xchachapoly = (
  ...
  return poly(ZERO, construct(plaintext, associated_data));
};
...
export const polyxchacha = (
  ...
  const calculated_tag = poly(ZERO, construct(ciphertext, associated_data));
