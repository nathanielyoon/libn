...
describe("create", { beforeAll: setup }, () => {
  it("ce() creates tags", () => {
    const a = ce("a");
  ...
  it("ce() attaches known listeners", () =>
  ...
  it("ce() attaches arbitrary listeners", () =>
...
describe("query", { beforeAll: setup }, () => {
